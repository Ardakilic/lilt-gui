...
describe('HelpDialog Component', () => {
  ...
  it('renders all help sections', () => {
    ...
    expect(screen.getByText('Built-in Docker integration for hassle-free transcoding')).toBeInTheDocument();
    ...
    expect(screen.getByText('2. Select source folder containing your audio files')).toBeInTheDocument();
  ...
  it('opens project links when clicked', () => {
    ...
    expect(mockElectronAPI.openExternal).toHaveBeenCalledWith('https://github.com/Ardakilic/lilt-gui');
  });
